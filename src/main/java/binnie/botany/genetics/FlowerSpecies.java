...
public enum FlowerSpecies implements IAlleleFlowerSpecies {
    ...
    ROSE("rose", "rosa", "grandiflora", EnumFlowerType.ROSE, EnumFlowerColor.RED),
    ...
    LILY("lily", "lilium", "longiflorum", EnumFlowerType.LILY, EnumFlowerColor.PINK, EnumFlowerColor.GOLD),
    ...
    SCABIOUS("scabious", "scabiosa", "atropurpurea", EnumFlowerType.SCABIOUS, EnumFlowerColor.ROYAL_BLUE),
